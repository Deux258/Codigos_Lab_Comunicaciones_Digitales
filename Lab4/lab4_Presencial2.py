...
class lab4_Presencial2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_constellation_decoder_cb_0 = digital.constellation_decoder_cb(constellation_object)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(constellation_object.points(), 1)
    ...
    def set_constellation_object(self, constellation_object):
        ...
        self.digital_constellation_decoder_cb_0.set_constellation(self.constellation_object)
